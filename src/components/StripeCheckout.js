    ...
    <div>
      {
        succeeded ? (
          ...
          <article>
            ...
            <p>Test Card Number: 4000 0062 0000 0007</p>
          </article>
        )
      }
      <form id="payment-form" onSubmit={handleSubmit}>
        ...
        <p className={`result-message ${!succeeded && 'hidden'}`}>
          Payment succeeded, see the result in your <a href={`https://dashboard.stripe.com/test/payments`} target="_blank" rel="noopener noreferrer">
            Stripe dashboard
